...
for hh in hhs
    # Run Training
    HMM_Forecast.trainBasisModel(hh, "A", numberOfObservationsVector, [200])
    HMM_Forecast.trainBasisModel(hh, "B", numberOfObservationsVector, numberOfStatesVector)

    # Run evaluation
    HMM_Forecast.hyperparameterAnalysis(hh, "A", numberOfObservationsVector, [200])
