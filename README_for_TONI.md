...
## Task 1: Erste Modelle berechnen
- Beschreibung: Berechnung von 8 Modellen, mit welchen ich erste Rückschlüsse ziehen möchte ob das endlich ausreicht oder ob noch größere Modelle berechnet werden sollen.
- Task: 
...
## Task 2: Restliche Experimente ausführen
